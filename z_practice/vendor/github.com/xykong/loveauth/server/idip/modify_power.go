...
func init() {
	...
	handlerFuncList[DO_MODIFY_POWER_REQ] =
		handlerFuncInfo{"modify_power", modify_power}
}

const DO_MODIFY_POWER_REQ = 0x1007
const DO_MODIFY_POWER_RSP = 0x1008

//
// 修改体力值请求
// Binding from JSON
type DoModifyPowerReq struct {
...
//
// in: body
// swagger:parameters idip_modify_power
type DoModifyPowerReqBodyParams struct {
	//
	// swagger:allOf
	// in: body
	DoModifyPowerReq DoModifyPowerReq
}

//
// 修改体力值应答
// swagger:response DoModifyPowerRsp
type DoModifyPowerRsp struct {
	// in: body
	Body struct {
		Head Header `json:"head"`
		Body struct {
...
/*
    <entry cmd="10356003" req="IDIP_DO_MODIFY_POWER_REQ" rsp="IDIP_DO_MODIFY_POWER_RSP" req_value="area=AreaId#platid=PlatId#openid=OpenId#modify_num=ModifyNum#source=Source#serial=Serial" rsp_value="result=Result#error_info=RetMsg#before_num=BeforeNum#after_num=AfterNum" desc="修改体力值"/>

    <macro name="IDIP_DO_MODIFY_POWER_REQ" value="0x1007" desc="修改体力值请求"/>
    <macro name="IDIP_DO_MODIFY_POWER_RSP" value="0x1008" desc="修改体力值应答"/>

	<!--修改体力值请求-->
	<struct name="DoModifyPowerReq" id="IDIP_DO_MODIFY_POWER_REQ" desc="修改体力值请求">
	...
	<!--修改体力值应答-->
	<struct name="DoModifyPowerRsp" id="IDIP_DO_MODIFY_POWER_RSP" desc="修改体力值应答">
...
*/
// swagger:route POST /idip/modify_power idip idip_modify_power
//
// modify_power: 修改体力值
//
// IDIP命令编码 <br>
//   IDIP_DO_MODIFY_POWER_REQ = 0x1007 <br>
//   IDIP_DO_MODIFY_POWER_RSP = 0x1008 <br>
//
//     Consumes:
//     - application/json
//
...
//
//     Responses:
//       200: DoModifyPowerRsp
func modify_power(c *gin.Context) {

	resp := DoModifyPowerRsp{}
	resp.Body.Head.PacketLen = 0
	resp.Body.Head.Cmdid = DO_MODIFY_POWER_RSP
	...
	for count := 0; count <= RandReqCount; count++ {
		...
		url := fmt.Sprintf("%s/%s", game, "modify_power")
		...
		SendIDIPTLog(int(AreaId), OpenId, Item_Power, int(int64(request.Body.ModifyNum)), request.Body.Serial, int(request.Body.Source),
			DO_MODIFY_POWER_REQ, request.Head.Seqid, int(PlatId))
